...
const authenticationMiddleware = async (req, res, next) => {const authHeader = req.headers.authorization
if (!authHeader || !authHeader.startsWith('Bearer ')) { throw new UnauthenticatedError('No token provided')
 ...
 req.user = { id, username }
  ...
  catch (error) { throw new UnauthenticatedError('Not authorized to access this route')
  }
}
